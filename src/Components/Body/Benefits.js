    ...
    return (
        <div>
            ...
            <p style={{ textAlign: 'left' }}>
                Наша компания — не очередной туроператор на рынке.<br/>
                Пользуясь нашими услугами, вы получаете список существенных преимуществ:
                ...
                <ol>
                    ...
                    <li value={5}>Надёжность, гарантированная честным договором с туристами</li>
